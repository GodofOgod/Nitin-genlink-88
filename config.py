...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8492085039:AAEsrC_jx8e5UyZFN1ketqXsshAnUDwtZh0")
APP_ID = int(os.environ.get("APP_ID", "25974254")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "c8cc6ccf7db5a6885299ab29663a5f9c") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002399067702")) #Your db channel Id
OWNER = os.environ.get("OWNER", "Autopos5566tbot") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "1489652480")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://wemedia360:DfQbsNu54pMHTkUy@deamxbotz1.lfquley.mongodb.net/?retryWrites=true&w=majority&appName=deamxbotz1")
DB_NAME = os.environ.get("DATABASE_NAME", "nitin")
#--------------------------------------------
